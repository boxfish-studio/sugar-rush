                ...
                {searchResults.map((account) => (
                    ...
                    >
                        ...
                        <div className=' flex justify-around w-full flex-wrap'>
                            <Link href={`/${account}`}>
                                <a className='mt-4 md:mt-8 px-4 py-2 text-white transition-all duration-300 ease-linear shadow-lg cursor-pointer rounded-xl bg-blue-regular hover:bg-blue-dark'>
                                    Inspect
                                </a>
                            </Link>
                            <button
