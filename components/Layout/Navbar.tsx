...
const Navbar: FC = () => {
    ...
    return (
        <div
            className={`${
                !publicKey ? 'pointer-events-none opacity-50' : ''
            } fixed top-0 left-0 z-10 flex flex-row md:flex-col items-end w-screen md:w-32 transition-all ease-linear h-24 md:h-screen m-0 text-white shadow-lg bg-slate-300`}
        >
            <SideBarElement tooltip='Manage Candy Machines' href='/' text='Manage CMs' />
