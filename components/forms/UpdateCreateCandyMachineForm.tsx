...
import {
    ...
    loadCandyProgramV2,
    updateCandyMachineV2,
    uploadCandyMachineV2,
    verifyAssets,
...
const UpdateCreateCandyMachineForm: FC<{
    ...
    const { onChange, onSubmit, values } = useForm(
        updateCandyMachine ? _updateCandyMachineV2 : _createCandyMachineV2,
        initialState
    )
    ...
    async function _createCandyMachineV2() {
        ...
        if (publicKey && anchorWallet) {
            ...
            try {
                const _candyMachine = await uploadCandyMachineV2({
    ...
    async function _updateCandyMachineV2() {
        try {
    ...
    return (
        <form style={{ maxWidth: '700px' }} className='w-full flex flex-col items-center h-auto justify-center mt-4' onSubmit={onSubmit}>
            <div className='w-full flex flex-col p-6 xxl-shadow rounded-2xl scale-90 bg-slate-300 items-center justify-center'>
                <FormInput
                    id='price'
