...
//   withdrawBundlr,
// } from 'lib/helpers/upload/arweave-bundle';
// import { awsUpload } from 'lib/helpers/upload/aws';
// import { ipfsCreds, ipfsUpload } from 'lib/helpers/upload/ipfs';
import { Manifest } from 'lib/types'
import { arweaveUpload } from './arweave'
import { createCandyMachineV2, getFileExtension, getFileName, sleep } from './helpers'

// import { nftStorageUpload } from 'lib/helpers/upload/nft-storage';
// import { pinataUpload } from 'lib/helpers/upload/pinata';
// import { setCollection } from './set-collection';

type AssetKey = { mediaExt: string; index: string }

export async function uploadCandyMachineV2({
    files,
    cacheName,
    env,
    totalNFTs,
