...
const CandyMachine: NextPage = () => {
    ...
    return (
        <>
            ...
            <div className='container flex justify-center items-center flex-col mb-10'>
                ...
                <div className='flex justify-center items-start flex-col mb-10 width-full p-0 gap-10'>
